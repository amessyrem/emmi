...
class BakliyatSahipleriEkrani extends StatefulWidget {
  final String altKategori;
  const BakliyatSahipleriEkrani({Key? key, required this.altKategori}) : super(key: key);

  @override
  _BakliyatSahipleriEkraniState createState() => _BakliyatSahipleriEkraniState();
}

class _BakliyatSahipleriEkraniState extends State<BakliyatSahipleriEkrani> {
  String? selectedIl;
  String? selectedIlce;
