...
class MeyveSahipleriEkrani extends StatefulWidget {
  final String altKategori;
  const MeyveSahipleriEkrani({Key? key, required this.altKategori}) : super(key: key);

  @override
  _MeyveSahipleriEkraniState createState() => _MeyveSahipleriEkraniState();
}

class _MeyveSahipleriEkraniState extends State<MeyveSahipleriEkrani> {
  String? selectedIl;
  String? selectedIlce;
    ...
    return Scaffold(
      ...
      body: Stack(
        children: [
          Positioned.fill(
            child: Image.asset(
              'assets/images/meyveekranı.png',//background burda
              fit: BoxFit.cover,
            ),
          ),
          Column(
    ...
    return Scaffold(
      ...
      body: Stack(
        children: [
          Positioned.fill(
            child: Image.asset(
              'assets/images/meyveekranı.png', // Arka plan resmi
              fit: BoxFit.cover,
            ),
          ),
          Padding(
