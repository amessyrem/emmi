...
class HayvansalUrunlerEkrani extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    List<Map<String, String>> hayvansalUrunler = [
      ...
      {"isim": "Tereyağ", "resim": "assets/images/tereyag-1.png"},
                ...
                return InkWell(
                  onTap: () {
                    Navigator.push(
                      ...
                      MaterialPageRoute(
                        builder: (context) =>
                            HayvansalurunSahipleriEkrani(altKategori: urun["isim"]!),
                      ),
                    );
                  },
                  child: Container(
                    decoration: BoxDecoration(
                      color: const Color(0x77FFFFFF), // Yarı saydam beyaz
...
class HayvansalurunSahipleriEkrani extends StatefulWidget {
  final String altKategori;
  const HayvansalurunSahipleriEkrani({Key? key, required this.altKategori}) : super(key: key);

  @override
  _HayvansalurunSahipleriEkraniState createState() => _HayvansalurunSahipleriEkraniState();
}

class _HayvansalurunSahipleriEkraniState extends State<HayvansalurunSahipleriEkrani> {
  String? selectedIl;
  String? selectedIlce;
    ...
    return Scaffold(
      ...
      body: Stack(
        children: [
          Positioned.fill(
            child: Image.asset(
              'assets/images/backhayvansal.png',//background burda
              fit: BoxFit.cover,
            ),
          ),
          Column(
